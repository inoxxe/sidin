...
<div class="content-wrapper">
 ...
 <h3>Selamat Datang</h3>
  <p class='lead'>NIM "; ?><?php echo $this->session->userdata('username'); ?><?php echo " Nama ";?><?php echo $mhs['nama'];?><?php echo " Jenis Kelamin ";?><?php echo $mhs['jns_klmn'];?><?php echo " Tanggal Lahir : "?><?php echo $mhs['lahir'];?><?php echo " alamat ";?><?php echo $mhs['alamat']?><?php echo " jurusan ";?><?php echo $mhs['jurusan']?><?php echo " Orang Tua ";?><?php echo $mhs['orangtua']?><?php
    }?>
