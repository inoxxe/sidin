        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="<?php echo base_url().'index.php/admin/prosesedit'; ?>"  role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="time" class="form-control" name="jamm" value="<?php echo $jammulai; ?>">
                  </div>

                  <div class="form-group">
                    <label>Jam Selesai Mata Kuliah</label>
                    <input type="time" class="form-control" name="jams" value="<?php echo $jamselesai; ?>">
                  </div>
                </div>
