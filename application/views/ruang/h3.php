            ...
            <div class="small-box bg-info">
              ...
              <div class="icon">
                ...
                if($res>0){
                    ...
                    <?php echo "<a href=";?><?php echo base_url('index.php/control_peminjaman/pilih/').$ruang;?><?php echo" class='small-box-footer'>Pilih<i class='fa fa-arrow-circle-right'></i></a>";?><?php
                  }else{
